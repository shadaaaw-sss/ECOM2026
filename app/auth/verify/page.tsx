          ...
          {status === 'success' && (
            <div className="py-6 flex flex-col items-center">
              ...
              <h2 className="font-serif text-2xl font-bold text-foreground mb-2">
                {t('verify_success_title' as any) || 'Email Verified!'}
              </h2>
              <p className="text-muted-foreground text-sm font-sans mb-6">
                {t('verify_success_desc' as any) || 'Your email has been verified successfully. You can now access all store functionalities.'}
              </p>
